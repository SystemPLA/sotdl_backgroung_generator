...
class HumanBackgroundGenerationTable : GenerationTable {
    ...
    override fun generateProperty(inputParameter: Int): String {
        return when (inputParameter) {
            ...
            3 -> "You spent " + DiceRoller.roll(6).toString() + " years as a prisoner in a dungeon."
            ...
            7 -> "The faerie held you prisoner for " +DiceRoller.roll(20).toString() + " years."
            ...
            12 -> "You have a spouse and "+ ChildrenCounter.countChildren(DiceRoller.roll(6), -2).toString() +" children."
            ...
            20 -> "You came into money and start the game with" + DiceRoller.roll(6,2).toString() +" cp."
